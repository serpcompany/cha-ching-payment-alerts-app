...
App Store Connect app ID: `6800029282`. Version `1.0` is `WAITING_FOR_REVIEW` in submission `41946309-b89e-438e-92f4-974499de05f7`.
...
Version `1.0`, build `28`, the `Cha-Ching Full Access` subscription group, and the first `Cha-Ching Annual` subscription were submitted together to App Review on 2026-08-12 at 15:38:30 UTC. Submission `41946309-b89e-438e-92f4-974499de05f7` is `WAITING_FOR_REVIEW`.
