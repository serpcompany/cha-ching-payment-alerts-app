...
- Foreground delivery requests Apple's real banner, list, sound, and badge presentation. Apple limits the abbreviated system preview to a few lines; pressing the notification opens the app's full scrollable detail presentation with every selected custom field.
