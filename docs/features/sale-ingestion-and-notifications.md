...
- Notification taps and foreground delivery trigger a fresh sales-history fetch. A notification tap returns control to UIKit on the main thread so cold-launch state restoration cannot crash the app.
