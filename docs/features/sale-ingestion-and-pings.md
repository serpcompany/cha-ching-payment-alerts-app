...
Custom webhook ingestion is documented separately in `custom-webhook-payment-sources.md`. It trusts possession of the source's private URL rather than claiming provider verification, and it never stores the active raw payload.
