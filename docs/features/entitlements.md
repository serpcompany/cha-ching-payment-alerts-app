...
All three are enabled by default when first materialized for an MVP user. D1 is the source of truth. The iOS Settings UI reports state but cannot mutate it.
