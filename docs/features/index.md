...
| Dashboard, navigation, and notification brand | Focused MVP dashboard, device toggle, genuine Apple notification presentation, crash-safe cold-launch details, delayed lock test, and verified dollar icon available in internal TestFlight build 11 | `dashboard-navigation-and-brand.md` |
...
| Custom webhook payment sources | Production Worker deployed; immediate native and crash-safe delayed lock-screen tests available in internal TestFlight build 11; signed-device source acceptance pending | `custom-webhook-payment-sources.md` |
