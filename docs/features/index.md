...
| Dashboard, navigation, and notification brand | Implemented and available in internal TestFlight build 8 | `dashboard-navigation-and-brand.md` |
...
| Custom webhook payment sources | Production Worker deployed; all-fields Notification settings and real test notification available in internal TestFlight build 8; signed-device source acceptance pending | `custom-webhook-payment-sources.md` |
