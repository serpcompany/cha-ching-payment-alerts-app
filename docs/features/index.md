...
| Dashboard, navigation, and notification brand | Requested behavior documented; implementation and TestFlight verification pending | `dashboard-navigation-and-brand.md` |
...
| Custom webhook payment sources | Production Worker deployed; separate all-fields Notification settings experience available in internal TestFlight build 7; signed-device source acceptance pending | `custom-webhook-payment-sources.md` |
