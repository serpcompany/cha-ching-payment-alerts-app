...
| Dashboard, navigation, and notification brand | Focused MVP dashboard, device toggle, genuine Apple notification presentation, tap-through full details, delayed lock test, and verified dollar icon available in internal TestFlight build 10 | `dashboard-navigation-and-brand.md` |
...
| Custom webhook payment sources | Production Worker deployed; immediate native and delayed lock-screen tests available in internal TestFlight build 10; signed-device source acceptance pending | `custom-webhook-payment-sources.md` |
