...
5. For tracked work, use GitHub Issues and keep the active execution plan current under `docs/exec-plans/active/`.
...
- Update feature docs, ADRs, and the active execution plan when behavior or decisions change.
