...
- Custom sources issue a stable private webhook URL, provide a copyable AI-agent/developer setup prompt, learn a user-selected mapping from one encrypted setup sample, and let the user show, hide, rename, or remap every discovered notification field before activation.
